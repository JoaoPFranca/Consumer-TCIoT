        ...
        if temp is not None:
            ...
            if novo_estado != self.estado_alerta[disp]["temperatura"]:
                ...
                if novo_estado != "NORMAL":
                    self.notificar(f"{novo_estado}: Temperatura anormal. {temp}C no {disp}.", novo_estado, "temperatura", dados)
                else:
                    self.notificar(f"NORMAL: Temperatura normalizada. {temp}C no {disp}.", "NORMAL", "temperatura", dados)
